...
/*------------------------------------------------------------------------------
 *	$Id: f_area_hist.h 940 2007-01-31 12:56:27Z mishadm $
 *
...
#ifndef __surfit_f_area_hist_included__
#define __surfit_f_area_hist_included__
...
*/
class f_area_hist : public functional {
public:

	//! constructor
	f_area_hist(const d_area * iarea, const d_hist * hist, REAL imult, bool iinside = true);
	//! destructor
	~f_area_hist();
