...
functional("f_area_mean", F_CONDITION) 
{
	mean = imean;
	area = iarea;
	mult = imult;
...
bool f_area_mean::make_matrix_and_vector(matr *& matrix, extvec *& v, bitvec * mask_solved, bitvec * mask_undefined) 
{
...
void f_area_mean::get_area_mask(const bitvec * mask_undefined) {
