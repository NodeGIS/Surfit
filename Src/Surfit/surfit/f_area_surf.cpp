...
bool f_area_surf::make_matrix_and_vector(matr *& matrix, extvec *& v, bitvec * mask_solved, bitvec * mask_undefined) 
{
	if (srf->getName())
...
void f_area_surf::get_area_mask(bitvec * mask_undefined) {
